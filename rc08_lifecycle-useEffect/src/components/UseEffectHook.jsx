...
const UseEffectHook = () => {
    ...
    // Dependency Array hiç olmazsa, silinirse ComponentDidMount + ComponentDidUpdate gibi çalışır. belirli bir state olmadığından herhangi bir state değişince her zaman çalışır.
