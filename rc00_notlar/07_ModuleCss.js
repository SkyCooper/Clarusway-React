...
// react uygulamaları singel-page application olduğundan; yazılan ne kadar component ve harici css dosyası varsa hepsi en sonunda index.html içinde id'si root olan div içine basılır. bundan dolayı bir harici A klasörü içinde bulunan A.css dosyası içindeki .title classı için uygulanan css, B klasöründeki B.jsx dosyasına import edilmese bile herhangi bir elemente className olark verilirse css uygular. veya B klasöründeki B.css içinde .title classı için css tanımlanırsa A.css'teki .title classı ile çakışır veya birbirini ezer, karmaşıklık olur. eğer pure CSS kullanılacaksa her class ve id uniq isimli olmak zorunda yoksa çakışma olur. (.btn-title .card-title .img-title gibi,)



//* bundan kurtulmanın yolu module-css kullanmak
// çünkü webpack içindeki derleyici .module.css olarak okuyunca dosya ismini arka planda hepsine kendisi uniq class ismi veriyor.
